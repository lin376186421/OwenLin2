...
extension ViewController : UITableViewDelegate, UITableViewDataSource, UITabBarControllerDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            self.navigationController?.pushViewController(YYProvider.customBouncesStyle(), animated: true)
        default:
            self.navigationController?.pushViewController(YYProvider.tabbarWithNavigationStyle(), animated: true)
