...
class CC_EX_DLL CCLabelBMFontLoader : public CCNodeLoader {
    ...
    protected:
        ...
        virtual void onHandlePropTypeFloat(CCNode * pNode, CCNode * pParent, const char* pPropertyName, float pFloat, CCBReader * pCCBReader); //-fix by qsun
    
        virtual void onHandlePropTypeIntegerLabeled(CCNode * pNode, CCNode * pParent, const char* pPropertyName, int pIntegerLabeled, CCBReader * pCCBReader); //-fix by qsun
};
