...
{
    return new CTextInputFieldWp8(pTextInputField);
}

CTextInputFieldWp8::CTextInputFieldWp8(CTextInputField* pTextInputField)
...
CTextInputFieldWp8::~CTextInputFieldWp8()
{
	
}

void CTextInputFieldWp8::doAnimationWhenKeyboardMove(float duration, float distance)
...
bool CTextInputFieldWp8::initWithSize(const CCSize& size)
{
...
void CTextInputFieldWp8::setFont(const char* pFontName, int fontSize)
{
	if(m_pLabel != NULL) {
...
void CTextInputFieldWp8::setFontColor(const ccColor3B& color)
{
    m_colText = color;
    m_pLabel->setColor(color);
}

void CTextInputFieldWp8::setPlaceholderFont(const char* pFontName, int fontSize)
{
	if(m_pLabelPlaceHolder != NULL) {
		m_pLabelPlaceHolder->setFontName(pFontName);
		m_pLabelPlaceHolder->setFontSize(fontSize);
...
void CTextInputFieldWp8::setPlaceholderFontColor(const ccColor3B& color)
{
    m_colPlaceHolder = color;
    m_pLabelPlaceHolder->setColor(color);
}

void CTextInputFieldWp8::setInputMode(TextFieldInputMode inputMode)
{
    m_eTextFieldInputMode = inputMode;
}

void CTextInputFieldWp8::setMaxLength(int maxLength)
{
    m_nMaxLength = maxLength;
}

int CTextInputFieldWp8::getMaxLength()
{
    return m_nMaxLength;
}

void CTextInputFieldWp8::setInputFlag(TextFieldInputFlag inputFlag)
{
    m_eTextFieldInputFlag = inputFlag;
}

void CTextInputFieldWp8::setReturnType(KeyboardReturnType returnType)
{
    m_eKeyboardReturnType = returnType;
}

bool CTextInputFieldWp8::isEditing()
{
    return false;
}

void CTextInputFieldWp8::setText(const char* pText)
{
    if (pText != NULL)
    {
        m_strText = pText;
...
const char*  CTextInputFieldWp8::getText(void)
{
    return m_strText.c_str();
}

void CTextInputFieldWp8::setPlaceHolder(const char* pText)
{
    if (pText != NULL)
    {
...
void CTextInputFieldWp8::setPosition(const CCPoint& pos)
{ // don't need to be implemented on android platform.
	
}

void CTextInputFieldWp8::setVisible(bool visible)
{ // don't need to be implemented on android platform.
    
}

void CTextInputFieldWp8::setContentSize(const CCSize& size)
{ // don't need to be implemented on android platform.
	
}

void CTextInputFieldWp8::setAnchorPoint(const CCPoint& anchorPoint)
{ // don't need to be implemented on android platform.
	
}

void CTextInputFieldWp8::visit(void)
{ // don't need to be implemented on android platform.
    
}

void CTextInputFieldWp8::onEnter(void)
{ // don't need to be implemented on android platform.
...
void CTextInputFieldWp8::openKeyboard()
{
    if (m_pDelegate != NULL)
    {
...
//void CTextInputFieldWp8::showTextFieldInputDialogJNI() {
//
...
void CTextInputFieldWp8::closeKeyboard()
{
